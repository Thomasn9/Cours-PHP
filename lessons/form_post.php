        ...
        <div class="content-grid">
            <main class="main-content">
                <section id="introduction">
                    <h2>Introduction</h2>
                    <p>Les formulaires sont un élément essentiel de toute application web interactive. Ils permettent
                        aux utilisateurs de soumettre des données qui peuvent être traitées par le serveur. En PHP, nous
                        pouvons récupérer ces données via les superglobales <code>$_GET</code> et <code>$_POST</code>.
                    </p>

                    <p>Dans ce cours, nous allons nous concentrer sur la méthode POST, qui est généralement utilisée
                        pour envoyer des données sensibles ou volumineuses, car contrairement à GET, les données ne sont
                        pas visibles dans l'URL.</p>
                </section>
                ...
                <section id="bonnes-pratiques">
                    ...
                    <div class="note">
                        <h3>Validation des Données</h3>
                        <p>Il est essentiel de valider toutes les données entrantes. Votre code vérifie déjà que les
                            champs ne sont pas vides, mais vous pourriez ajouter d'autres validations :</p>
                        <ul>
                    ...
                    <div class="warning">
                        ...
                        <p>Lorsque vous affichez des données utilisateur, utilisez toujours
                            <code>htmlspecialchars()</code> pour éviter les attaques XSS (Cross-Site Scripting).</p>
                        <div class="code-block">
                            <span class="code-comment">// Mauvaise pratique (vulnérable aux XSS)</span><br>
                            <span class="code-keyword">echo</span> <span class="code-variable">$_POST</span>[<span
                ...
                <div class="resources">
                    ...
                    <ul>
                        ...
                        <li><a href="https://www.php.net/manual/fr/function.empty.php" target="_blank">Documentation
                                PHP: empty()</a></li>
                        <li><a href="https://www.php.net/manual/fr/function.htmlspecialchars.php"
                                target="_blank">Documentation PHP: htmlspecialchars()</a></li>
                    </ul>
                </div>
            </aside>
        </div>
