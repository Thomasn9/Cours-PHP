...
<head>
    ...
    <link rel="stylesheet" href="../../Cours-PHP/src/index.css">
...
<body>
    <main>
        <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="../../Cours-PHP/public/boostrap.png" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">boostrap</h5>
                <p class="card-text">Acces au framwork boostrap</p>
